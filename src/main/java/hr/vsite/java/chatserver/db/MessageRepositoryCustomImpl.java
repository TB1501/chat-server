...
public class MessageRepositoryCustomImpl implements MessageRepositoryCustom {
    ...
    public class Mapper implements RowMapper<Message> {
        ...
        public Message mapRow(java.sql.ResultSet rs, int i) throws java.sql.SQLException {
            ...
            message.setUser(userRepository.findByUserNameStartsWith(rs.getString("user_name")).get(0));
            message.setGroup(groupRepository.findAllByGroupNameContaining(rs.getString("group_name")).get(0));
            return message;
        }
    }
